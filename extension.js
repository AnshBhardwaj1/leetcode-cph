...
function activate(context) {
    console.log('Congratulations, your extension "cphlc" is now active!');

    // Register the "fetch" command to retrieve test cases
    let fetchCommand = vscode.commands.registerCommand('cphlc.fetch', async (problemUrl) => {
        try {
    ...
    let runCommand = vscode.commands.registerCommand('cphlc.run', async () => {
        try {
